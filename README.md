<!-- Generated by scripts/generate_readme.py from metadata.yml. Do not edit by hand; run `just readme`. -->
...
- [Telemedicine visits for new onychomycosis diagnoses result in fewer antifungal prescriptions than in-person care: A retrospective cohort study](<Publications/014 Telemedicine Visits for New Onycomycosis Diangoses/Telemedicine Visits for New Onychomycosis Diagnoses Result in Fewer Antifungal.pdf>)
...
- [Heart Transplant Outcomes in Patients with Substance Use Disorder History: A Nationwide Cohort Study Using High-Dimensional Propensity Score Matching](<Publications/017 Heart Transplant Outcomes in SUD/Heart transplant outcomes in patients with substance use disorder history- a nationwide cohort study using high-dimensional propensity score matching.pdf>)
...
- [Patients with Quiescent Inflammatory Bowel Disease Have Increased Risk of Steroid Prescription Following Surveillance Colonoscopy](<Abstracts/013 IBD Surveillance Colonoscopy Steroids/>)
- [GLP-1 Agonists Can Prevent Liver Disease Progression in Patients with Metabolic and Alcohol-Associated Liver Disease (MetALD)](<Abstracts/016 GLP-1 Liver Disease MetALD/>)
- [Among Patients with IBD, Use of Statins is Associated with Lower Risk of Developing De Novo Primary Sclerosing Cholangitis](<Abstracts/017 IBD Statins PSC/>)
- [Leukocytosis and Healthcare Utilization in Patients with Cannabis Hyperemesis Syndrome Presenting to the Emergency Department](<Abstracts/018 Cannabis Hyperemesis Leukocytosis/>)
- [Utilization of High-Sensitivity C-Reactive Protein Testing in Primary and Secondary ASCVD Prevention](<Abstracts/020 hs-CRP Testing in ASCVD Prevention/Utilization of High-Sensitivity C-Reactive Protein Testing in Primary and Secondary ASCVD Prevention.pdf>)
- [Increase in Mortality and Allograft Rejection Post-Liver Transplant in a Cohort Between 50-90 Years Old](<Abstracts/021 Post-Liver Transplant Outcomes in Elderly/Increase in Mortality and Allograft Rejection Post-Liver Transplant in a Cohort Between 50-90 Years Old.pdf>)
...
- [Single-Site Retrospective Cohort Study of Oral and Dental Disease Associated with Buprenorphine Use](<Unpublished/001 Single-Site Retrospective Cohort Study of Oral and Dental Disease Associated with Buprenorphine Use.pdf>)
